...
<body>
	...
	<div class="box">
		...
		<h2>月票榜单</h2>
		<ul>
			<div><i class="i1"><img src="images/wuxia1.jpg"></i><li class="l1"><a href="wuxia.php">武侠世界</a></li><span><?php echo $result['vote_count']; ?></span></div>
			<div><i class="i1"><img src="images/meiju1.jpg"></i><li class="l1"><a href="meiju.php">美剧世界</a></li><span><?php echo $result1['vote_count']; ?></span></div>
		    <div><i class="i3"><img src="images/shenhua1.jpg"></i><li class="l1"><a href="shenhua.php">神话基因</a></li><span><?php echo $result2['vote_count']; ?></span></div>
		    <div><i class="i3"><img src="images/zoulin1.jpg"> </i><li class="l1"><a href="zhoulin.php">纣临</a></li><span><?php echo $result3['vote_count']; ?></span></div>
		    <div><i class="i3"><img src="images/qiji1.jpg"></i><li class="l1"><a href="qiji.php">奇迹的召唤师</a></li><span><?php echo $result4['vote_count']; ?></span></div>
		</ul>
