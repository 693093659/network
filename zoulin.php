<?php
	...
	$sql="select * from comment_info where story_id=3 and comment_id=3";
	$rs1=$pdo->query($sql);
	$result1=$rs1->fetch(PDO::FETCH_ASSOC);
	$sql="select * from comment_info where story_id=3 and comment_id=2";
	$rs2=$pdo->query($sql);
	$result2=$rs2->fetch(PDO::FETCH_ASSOC);
	$sql="select * from comment_info where story_id=3 and comment_id=3";
	$rs3=$pdo->query($sql);
	$result3=$rs3->fetch(PDO::FETCH_ASSOC);
	$sql="select * from comment_info where story_id=3 and comment_id=4";
	$rs4=$pdo->query($sql);
...
<body>
		...
		<div class="box">
			...
			<div class="intr">
				...
				<div class="vote"><a href="vote.php?story_id=3" class="vote">投票</a></div>
				<p><?php echo $result['content'];?></p>
			</div>
			<div class="read"><a href="read.php?story_id=3&chapter_id=3" class="read_a">开始阅读</a></div>
		</div>
		<div class="sidebar1">
		<h2>月票榜单</h2>
		<ul>
		    ...
		    <i class="i3">4</i><li class="l1"><a href="zoulin.php">纣临</a></li><span><?php echo $result['vote_count']; ?></span>
		    <i class="i3">5</i><li class="l1"><a href="qiji.php">奇迹的召唤师</a></li><span>200</span>
		</ul>
		</div>
		<div class="command">
			<div class="c_head"><h2>评论区</h2><a href="command_Login.php?story_id=3" class="c_head_a">我要发帖</a> </div>
			<div class="command1">
