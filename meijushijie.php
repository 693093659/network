<?php 
	...
	$sql="select * from comment_info where story_id=4 and comment_id=1";
	$rs1=$pdo->query($sql);
	$result1=$rs1->fetch(PDO::FETCH_ASSOC);
	$sql="select * from comment_info where story_id=4 and comment_id=4";
	$rs2=$pdo->query($sql);
	$result2=$rs2->fetch(PDO::FETCH_ASSOC);
	$sql="select * from comment_info where story_id=4 and comment_id=3";
	$rs3=$pdo->query($sql);
...
<body>
		...
		<div class="box">
			...
			<div class="intr">
				...
				<div class="vote"><a href="vote.php?story_id=4" class="vote">投票</a></div>
				<p><?php echo $result['content'];?></p>
			</div>
			<div class="read"><a href="read.php?story_id=4&chapter_id=1" class="read_a">开始阅读</a></div>
		</div>
		<div class="sidebar1">
		<h2>月票榜单</h2>
		<ul>
			<i class="i1">1</i><li class="l1"><a href="wuxia.php">武侠世界</a></li><span>380</span>
			<i class="i1">2</i><li class="l1"><a href="meiju.php">美剧世界</a></li><span><?php echo $result['vote_count']; ?></span>
		...
		<div class="command">
			<div class="c_head"><h2>评论区</h2><a href="command_Login.php?story_id=4" class="c_head_a">我要发帖</a> </div>
			<div class="command1">
